var playlistData = [
    {
      ...
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20205919.png"
    },
    {
      "id": "2",
      "title": "Perfect Mashed Potatoes and Gravy",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210014.png"
    },
    {
      "id": "3",
      "title": "The Heart of Soba",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210037.png"
    },
    {
      "id": "4",
      "title": "Grilled Cheese 9 Ways",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210137.png"
    },
    {
      "id": "5",
      "title": "Pineapple Cheesecake",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210158.png"
    },
    {
      "id": "6",
      "title": "Lemony Chicken Noodle Soup",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210309.png"
    },
    {
      "id": "7",
      "title": "Pumpkin Roll",
    ...
    },
    {
      ...
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210411.png"
    },
    {
      "id": "9",
      "title": "Stop Motion Dry-Brined Turkey Recipe",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210431.png"
    },
    {
      "id": "10",
      "title": "Butternut Squash Ravioli",
      "thumbnail": "http://127.0.0.1:5500/Screenshot%202023-09-05%20210459.png"
    }
  ]
...
for(var i=0;i<playlistData.length;i++){
    if(i==0){
        ...
        <div id="card${i}" class="playlist-card active-card" onclick="selected(${i})" >
        <img class="thumbnail" src=${playlistData[i].thumbnail}  />
        <h3 class="video-card-title">${playlistData[i].title} </h3>
    </div>`
    }else{
        playlistWrapper.innerHTML += `
        <div id="card${i}" class="playlist-card" onclick="selected(${i})" >
        <img class="thumbnail" src=${playlistData[i].thumbnail} />
        <h3 class="video-card-title">${playlistData[i].title} </h3>
    </div>`
    }
...
function selected(id){
    ...
    $("#card"+id).addClass("active-card")
      playerWrapper.innerHTML = `
      <iframe id="video-player" src="https://player.vimeo.com/video/${videoPlaySectionData[id].vimeoId}" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
  
      <div>
          <div id="video-actions">
              <p><span id="views-count">${videoPlaySectionData[id].views/1000} k</span> views</p>
          ...
          <h3 id="video-title">${videoPlaySectionData[id].title}</h3>
          <p id="video-description">${videoPlaySectionData[id].description}</p>
      </div>`
